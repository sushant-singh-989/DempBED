			...
			<tbody>
				<c:forEach items="${Employees}" var="tempEmployee">
					<tr>
                        ...
                        <td>
                            <c:out value="${tempEmployee.id}" />
                        </td>
                        
						<td><c:out value="${tempEmployee.f_Name}" /></td>
                        
						<td><c:out value="${tempEmployee.l_Name}" /></td>
						...
						<td>
							...
							<c:url var="updateUrl" value="/emoloyees/showFormForUpdate?employeeId=${tempEmployee.id}" />
							...
							<c:url var="deleteUrl" value="/employees/delete?employeeId=${tempEmployee.id}" />
